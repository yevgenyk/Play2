 ...
 * @date 2014-11-14 ����6:05:44 
 *
 */

public class CRefreshLayout extends ViewGroup{
	private static final float DECELERATE_INTERPOLATION_FACTOR = .1f;//2f;
...
//                    float adjustedPercent = dragPercent;
    ...
    private void animateOffsetToStartPosition(long startOffset) {
        ...
        mAnimateToStartPosition.setDuration(20);//mMediumAnimationDuration);
